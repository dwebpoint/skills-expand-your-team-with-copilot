document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleShare(platform, activityName, description, schedule) {
    const shareUrls = createShareUrls(activityName, description, schedule);
    ...
    shareButtons.forEach((button) => {
      button.addEventListener("click", (e) => {
        ...
        if (e.currentTarget.classList.contains("share-twitter")) {
          ...
          platform = "facebook";
        } else if (e.currentTarget.classList.contains("share-linkedin")) {
          platform = "linkedin";
        }
        handleShare(platform, activityName, details.description, formattedSchedule);
      });
    });
